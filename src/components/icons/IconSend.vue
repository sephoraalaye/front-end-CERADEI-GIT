<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 70 70" fill="none">
    ...
    <path d="M36.2233 33.4515C36.5044 33.9385 36.338 34.5616 35.8504 34.8431L25.2637 40.9553L24.979 39.9434L24.245 39.1909L34.8317 33.0787C35.3193 32.7973 35.9421 32.9646 36.2233 33.4515Z" fill="url(#paint1_linear_1_489)"/>
    <path d="M25.2636 40.9554L35.8503 34.8432C36.3379 34.5617 36.5044 33.9387 36.2232 33.4517L24.9789 39.9435L25.2636 40.9554Z" fill="url(#paint2_linear_1_489)"/>
    <defs>
      <linearGradient id="paint0_linear_1_489" x1="49.6467" y1="1.96393" x2="19.564" y2="77.7643" gradientUnits="userSpaceOnUse">
        <stop stop-color="#747DEF"/>
        <stop offset="1" stop-color="#5E3BE1"/>
      </linearGradient>
      <linearGradient id="paint1_linear_1_489" x1="32.4078" y1="34.5441" x2="33.5453" y2="36.8251" gradientUnits="userSpaceOnUse">
        <stop stop-color="#747DEF"/>
        <stop offset="1" stop-color="#5E3BE1"/>
      </linearGradient>
      <linearGradient id="paint2_linear_1_489" x1="32.9028" y1="35.4017" x2="33.5069" y2="36.5259" gradientUnits="userSpaceOnUse">
        <stop stop-color="#747DEF"/>
        <stop offset="1" stop-color="#5E3BE1"/>
      </linearGradient>
    </defs>
